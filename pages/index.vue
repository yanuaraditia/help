    ...
    <div class="container mx-auto px-5 lg:w-10/12 xl:w-9/12 2xl:w-8/12 relative">
      <div class="grid xl:grid-cols-3 gap-3 xl:gap-6">
        <div v-for="(category, i) in categories" :key="`cat-${i}`"
             class="p-3.5 xl:p-7 transition-all group transition-all border relative rounded-3xl shadow-sm hover:shadow-lg overflow-hidden">
          <div
              class="inline-block mb-3 p-3 bg-primary-100 group-hover:bg-primary-500 text-primary-700 group-hover:text-primary-100 rounded-full">
          ...
          <h4 class="text-lg lg:text-2xl mb-3 text-primary-600 font-semibold relative"
